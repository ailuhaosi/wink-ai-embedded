...
| 关联设计规范 | [02-pal-platform-abstraction.md §3.3](../../design/02-wink-micro-os/02-pal-platform-abstraction.md#33-pal-irq-公开面收窄adr-0018)（已回写） |
...
1. **执行 Track F 升级计划**（3 天工作量）：
   ...
   - 清理重构 `test_pal_irq.c`。
2. **SSOT 设计规范回写**：
   - 决策 Accepted 后，回写并更新 [02-pal-platform-abstraction.md](../../design/02-wink-micro-os/02-pal-platform-abstraction.md) 中的中断与临界区小节。
3. **Codegen 提示词规整**：
