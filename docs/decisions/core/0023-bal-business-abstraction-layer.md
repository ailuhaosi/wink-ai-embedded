...
> **目录树与 helper 命名**：以 [06-bal-layer.md](../../design/02-wink-micro-os/06-bal-layer.md) + [ADR-0038](0038-bal-naming-hard-cut-and-layer-ssot.md) 为现行 SSOT。下文 §1 目录示意保留为历史快照；slot / 双轨 / 禁 PAL 头等决策仍有效。

| 项 | 内容 |
|---|---|
| 状态 | **Accepted（已接受）** |
| 日期 | 2026-07-06 |
| 触发 | [2026-07-06 BAL/DCST 架构重构方案](../../tech-designs/core/2026-07-06-bal-dcst-architecture-refactor.md) v5 Owner 审阅决策版 |
