...
| 状态 | **Accepted（已接受）** |
| 日期 | 2026-07-06 |
| 触发 | [2026-07-06 BAL/DCST 架构重构方案](../../tech-designs/core/2026-07-06-bal-dcst-architecture-refactor.md) v5 Owner 审阅决策版；2026-07-04 全量评审识别出 DAL deinit 缺失与 fault 模型模糊两项架构债 |
