...
| 状态 | **Accepted（已接受）** |
| 日期 | 2026-07-06 |
| 触发 | [2026-07-06 BAL/DCST 架构重构方案](../../tech-designs/core/2026-07-06-bal-dcst-architecture-refactor.md) v5；当前 `samples/devkitc_smoke/app_callbacks.c` file-scope pragma 把所有 deprecated warning 一刀切关掉，掩盖真 bug |
