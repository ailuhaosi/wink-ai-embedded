...
| 关联活规范（SSOT） | [coding-conventions.md §3](../../design/07-platform-governance/coding-conventions.md)；文件/域命名见 [06-bal-layer.md](../../design/02-wink-micro-os/06-bal-layer.md) |
...
细则、决策树、示例矩阵、硬性规则 → **[coding-conventions §3](../../design/07-platform-governance/coding-conventions.md)**（唯一 SSOT，本 ADR 不复述整表）。
