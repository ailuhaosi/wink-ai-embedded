...
> **命名硬切割与文件后缀**：见 [ADR-0038](0038-bal-naming-hard-cut-and-layer-ssot.md)；活规范全文：[06-bal-layer.md](../../design/02-wink-micro-os/06-bal-layer.md)。本 ADR 的三域划分与闭环安全约束仍有效；`*_controller` 文件名等以 0038 为准。
...
| 关联设计规范 | [06-bal-layer.md](../../design/02-wink-micro-os/06-bal-layer.md) |
...
*状态变更记录：*
- 2026-07-17：Accepted
- 2026-07-18：命名硬切割见 [ADR-0038](0038-bal-naming-hard-cut-and-layer-ssot.md)；活规范 [06-bal-layer.md](../../design/02-wink-micro-os/06-bal-layer.md)
