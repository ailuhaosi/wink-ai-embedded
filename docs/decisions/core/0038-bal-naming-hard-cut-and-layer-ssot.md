...
| 关联活规范（SSOT） | [06-bal-layer.md](../../design/02-wink-micro-os/06-bal-layer.md)；指针：[coding-conventions.md §4](../../design/07-platform-governance/coding-conventions.md) |
...
1. **活规范 SSOT**：BAL 域划分、命名、依赖、实现形态、CI 以 [`06-bal-layer.md`](../../design/02-wink-micro-os/06-bal-layer.md) 为唯一正文；本 ADR 只锁决策与硬切割映射。
...
3. 启用 [`06-bal-layer.md`](../../design/02-wink-micro-os/06-bal-layer.md) §6 CI 门禁。（**2026-07-18 落地**）
