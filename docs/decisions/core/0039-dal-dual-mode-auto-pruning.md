...
| 影响范围 | codegen `app_options.cmake`；`dal/CMakeLists.txt`；`core_sources.cmake`；`targets/esp32`；Binary SDK；Host 单 App 绑定 JSON 时的裁剪路径；活规范 [06-bal-layer.md §4.4](../../design/02-wink-micro-os/06-bal-layer.md) |
| 决策者 | 项目 Owner |
| 关联 ADR | 低代码裁剪背景见 app-layer 设计与 P2 评审；BAL stub 契约见 [ADR-0037](0037-bal-domain-partition-and-closed-loop-motor.md) / [06-bal-layer.md](../../design/02-wink-micro-os/06-bal-layer.md) |
| 关联活规范（SSOT） | [06-bal-layer.md §4.4](../../design/02-wink-micro-os/06-bal-layer.md)；codegen 管线见 [03-ai-dsl-and-codegen-pipeline.md](../../design/03-app-codegen/03-ai-dsl-and-codegen-pipeline.md) |
...
- [x] [06-bal-layer.md §4.4](../../design/02-wink-micro-os/06-bal-layer.md)（无 JSON 行为）— 2026-07-18 已回写
