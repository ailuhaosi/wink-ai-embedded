...
| 影响范围 | `wink-micro-os/targets/` 布局；新建 `wink-micro-os/osal/`；顶层与 ESP-IDF CMake 装配；活规范 [02-pal-platform-abstraction.md](../../design/02-wink-micro-os/02-pal-platform-abstraction.md)、[03-directory-architecture.md](../../design/02-wink-micro-os/03-directory-architecture.md) |
...
| 关联活规范（SSOT，Accepted 后回写） | [02-pal-platform-abstraction.md](../../design/02-wink-micro-os/02-pal-platform-abstraction.md)；[03-directory-architecture.md](../../design/02-wink-micro-os/03-directory-architecture.md) |
...
- [x] [03-directory-architecture.md](../../design/02-wink-micro-os/03-directory-architecture.md)：目录树、`osal/`、命名例外、targets 不再含 OSAL — 2026-07-19
- [x] [02-pal-platform-abstraction.md](../../design/02-wink-micro-os/02-pal-platform-abstraction.md)：实现位置改为 `targets/` + `osal/`；链接组合矩阵 — 2026-07-19
