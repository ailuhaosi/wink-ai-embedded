...
| 状态 | **Accepted（已采纳）** |
| 日期 | 2026-07-27 |
| 触发 | 新增外设需同步 4–7 处驱动列表；与 [ADR-0039](0039-dal-dual-mode-auto-pruning.md)「一处驱动表」目标仍有偏差；见 [tech-design](../../tech-designs/tools/2026-07-27-peripheral-onboarding-optimization-design.md) |
...
- [x] 回写 [01-dal-device-abstraction.md](../../design/02-wink-micro-os/01-dal-device-abstraction.md)（驱动发现 / 新增路径）— 2026-07-27
- [x] 回写 [03-ai-dsl-and-codegen-pipeline.md](../../design/03-app-codegen/03-ai-dsl-and-codegen-pipeline.md)（registry SSOT）— 2026-07-27
