...
| 关联活规范（B2 已回写） | [01-dal-device-abstraction.md](../../design/02-wink-micro-os/01-dal-device-abstraction.md) §8.1；[06-bal-layer.md](../../design/02-wink-micro-os/06-bal-layer.md) §4.6；[02-pal-platform-abstraction.md](../../design/02-wink-micro-os/02-pal-platform-abstraction.md) §2.2 |
