...
| 影响范围 | `dal/include/actuator/`；`wink_actuator_registry`；codegen Capability 别名层；[01-dal-device-abstraction.md](../../design/02-wink-micro-os/01-dal-device-abstraction.md) |
| 决策者 | 项目 Owner |
...
- [x] 回写 [01-dal-device-abstraction.md](../../design/02-wink-micro-os/01-dal-device-abstraction.md) §6.2 actuator 控制语义分类表 — 2026-07-28
...
活规范回写：[01-dal-device-abstraction.md §6.3](../../design/02-wink-micro-os/01-dal-device-abstraction.md)、[`dal-best-practices.md`](../../wink-micro-os/docs/dal-development-guide/dal-best-practices.md) §3.1。
