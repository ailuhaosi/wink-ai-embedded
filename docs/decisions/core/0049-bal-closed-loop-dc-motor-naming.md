...
| 影响范围 | `bal/include|src/control/wink_closed_loop_*.{h,c}`；`wink_chassis` 配置类型；对应 host 单测 / CMake；[06-bal-layer.md](../../design/02-wink-micro-os/06-bal-layer.md) |
| 决策者 | 项目 Owner |
...
| 关联活规范（SSOT） | [06-bal-layer.md](../../design/02-wink-micro-os/06-bal-layer.md) |
...
- [x] 回写 [06-bal-layer.md](../../design/02-wink-micro-os/06-bal-layer.md) 示例与目标态清单
