...
| 影响范围 | DAL/BAL 符号与文件；codegen `type`；`wink-app.json`；活规范 [01-dal-device-abstraction.md](../../design/02-wink-micro-os/01-dal-device-abstraction.md)、[06-bal-layer.md](../../design/02-wink-micro-os/06-bal-layer.md)；[ADR-0048](0048-actuator-control-semantic-naming.md) 预留名；role-intent 附录 C |
| 决策者 | 项目 Owner |
