...
/** Paint SSD1306 page-packed framebuffer onto a wokwi-ssd1306-like element. */
export function paintOledFramebuffer(
  oledEl: OledElementLike,
  newFb: Uint8Array | null,
): void {
